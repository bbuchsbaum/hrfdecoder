...
description: "Deep dive into the alternating least squares algorithm and parameter tuning."
output:
  rmarkdown::html_vignette:
    ...
    css: albers.css
vignette: >
  %\VignetteIndexEntry{Weakly supervised learning for fMRI}
...
if (requireNamespace("ggplot2", quietly = TRUE) &&
  ...
  ggplot2::theme_set(hrfdecode::theme_albers())
}
```
