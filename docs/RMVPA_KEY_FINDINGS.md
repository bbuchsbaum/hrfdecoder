...
1.  **`/R/allgeneric.R` (944 lines)**
    - Generic functions:
      ...
      [`predict_model()`](http://bbuchsbaum.github.io/rMVPA/reference/predict_model.md),
      ...
      [`compute_performance()`](http://bbuchsbaum.github.io/rMVPA/reference/compute_performance-methods.md)
    - Key class resolution dispatcher
    - `process_roi.default()` entry point (line 206-222) - controls flow
      to CV methods
2.  **`/R/mvpa_model.R` (387 lines)**
    - [`mvpa_model()`](http://bbuchsbaum.github.io/rMVPA/reference/mvpa_model.md)
      (line 260-337) - creates standard model spec
...
3.  **`/R/hrfdecoder_model.R` (336 lines)** - Already exists!
    ...
    - `format_result.hrfdecoder_model()` (line 216-297) - predicts +
      aggregates to events
    - `merge_results.hrfdecoder_model()` (line 303-328) - folds →
...
5.  **`/R/mvpa_iterate.R` (585 lines)**
    - `internal_crossval()` (line 224-296) - MAIN CV LOOP
      - Line 228-229: Generates folds via
        [`crossval_samples()`](http://bbuchsbaum.github.io/rMVPA/reference/crossval_samples.md)
      - Line 263-291: Per-fold training via
        [`train_model()`](http://bbuchsbaum.github.io/rMVPA/reference/train_model.md) +
        [`format_result()`](http://bbuchsbaum.github.io/rMVPA/reference/format_result.md)
      - Line 295: Merges via
        [`merge_results()`](http://bbuchsbaum.github.io/rMVPA/reference/merge_results.md)
    - `external_crossval()` (line 89-175) - for external test sets
    - Key insight: Data extraction (line 228) happens BEFORE fold
      creation
      - **This is where prewhitening must hook in (or inside
        `train_model`)**
6.  **`/R/crossval.R` (903 lines)**
    ...
    - Implementation:
      [`crossv_block()`](http://bbuchsbaum.github.io/rMVPA/reference/crossv_block.md)
      (line 170-192)
...
9.  **`/R/design.R` (344 lines)**
    ...
    - [`y_train()`](http://bbuchsbaum.github.io/rMVPA/reference/y_train-methods.md),
      [`y_test()`](http://bbuchsbaum.github.io/rMVPA/reference/y_test-methods.md)
      generics (line 366-383)
...
10. **`/R/classifiers.R` (739 lines)**
    ...
    - Each has `fit()`,
      [`predict()`](https://rdrr.io/r/stats/predict.html), `prob()`
      methods
...
hrfdecoder_model() spec creation

train_model.hrfdecoder_model() solver integration

format_result.hrfdecoder_model() event aggregation

merge_results.hrfdecoder_model() fold merging

hrfdecoder_design() for metadata

Blocked cross-validation (respects TR structure)
